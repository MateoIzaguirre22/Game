...
Public Class PictureBoxTransparente
    Inherits PictureBox
    ...
    Private Sub ChangeZOrder(ByVal value As Int32)
    ...
    Private Sub PaintSiblings(ByVal e As PaintEventArgs)
    ...
    Private Function GetScaledWidth(ByVal h As Integer) As Integer
        Dim scale As Single = CSng(Image.Width / Image.Height)
        Return CInt(h * scale)
    End Function

    Private Function GetScaledHeight(ByVal w As Integer) As Integer
